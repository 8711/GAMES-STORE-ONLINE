    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">TecLag Games Store</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown">
                ...
                <?php
                 print $_SESSION[ 'usuario_info' ][ 'nombre_usuario' ];
                ?>
        ...
        <div class="col-md-12">
          <fieldset>
            ...
            <form method="POST" action="../acciones.php" enctype="multipart/form-data" >
              <input type="hiddem" name= "id" value= "<?php print $resultado['id']?>">
              <div class="row">
                  <div class="col-md-6">
